      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
            {/* Info */}
            <div ref={infoRef} className="scroll-hidden-left">
              <span className="text-primary-600 font-bold uppercase tracking-wider text-sm">Get in Touch</span>
              <TypewriterText
                text="We're Here to Help"
                as="h2"
                speed={50}
                className="text-3xl font-bold text-slate-900 mt-2 mb-6"
              />
            ...
            {/* Form */}
            <div ref={formRef} className="bg-slate-50 p-8 md:p-10 rounded-3xl shadow-sm border border-slate-100 scroll-hidden-right">
