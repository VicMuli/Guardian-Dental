    ...
    <section className="relative bg-primary-50 py-20 lg:py-28 overflow-hidden">
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          <div ref={textRef} className="lg:w-1/2 space-y-8 scroll-hidden-left">
            ...
            <TypewriterText
              text="Your Smile is Our Top Priority"
              as="h1"
              speed={60}
          ...
          <div ref={imageRef} className="lg:w-1/2 relative scroll-hidden-right">
            <div className="relative z-10 rounded-3xl overflow-hidden shadow-2xl">
              <img
                ...
                className="w-full h-auto object-cover img-reveal scroll-visible"
              />
            </div>
  ...
  return (
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <div ref={ref} className="grid grid-cols-1 md:grid-cols-3 gap-8 scroll-hidden">
          {[
...
const AboutPreview = () => {
  ...
  const textRef = useScrollAnimation<HTMLDivElement>();
  const img1Ref = useScrollAnimation<HTMLImageElement>();
  const img2Ref = useScrollAnimation<HTMLImageElement>();

  return (
    <section className="py-20 bg-slate-50">
      <div className="container mx-auto px-4 flex flex-col lg:flex-row items-center gap-16">
        <div ref={imagesRef} className="lg:w-1/2 scroll-hidden-left">
          <div className="grid grid-cols-2 gap-4">
            <img ref={img1Ref} src="https://drive.google.com/thumbnail?id=1bNSteZkJIaaFAtuYzsAf4UUXi_eSNu8n&sz=w1000" alt="Clinic interior" className="rounded-2xl shadow-lg mt-8 img-reveal" />
            <img ref={img2Ref} src="https://drive.google.com/thumbnail?id=1PkiDEAPdTDOeDvdj7urPNW0-tbiPiCTa&sz=w1000" alt="Dentist working" className="rounded-2xl shadow-lg img-reveal" />
          </div>
        </div>
        <div ref={textRef} className="lg:w-1/2 space-y-6 scroll-hidden-right">
          <span className="text-primary-600 font-bold uppercase tracking-wider text-sm">About Us</span>
          <TypewriterText
            text="Dedicated to the Health of Your Smile"
            as="h2"
            speed={40}
...
const Testimonials = () => {
  ...
  return (
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <div ref={titleRef} className="text-center max-w-2xl mx-auto mb-16 scroll-hidden">
        ...
        <div ref={cardsRef} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 scroll-hidden">
          {[
            {
              name: "Wanjiku Mwangi",
              role: "Teacher",
...
const CTA = () => {
  ...
  return (
    <section className="py-20 bg-primary-600 text-white">
      <div ref={ref} className="container mx-auto px-4 text-center scroll-hidden-scale">
        <TypewriterText
          text="Ready to Brighten Your Smile?"
          as="h2"
          speed={45}
